...
+ (instancetype)sharedInstance
{
    ...
    dispatch_once(&onceToken, ^{
        instance = [[CrashLogManager alloc] init];
    });
    return instance;
}
...
- (id)init
{
    ...
    if ( self )
    {
        ...
        _crashLogPath = [sandBoxPath stringByAppendingPathComponent:@"CrashLogManager"];
...
{
    [[CrashLogManager sharedInstance] saveException:exception];
    [exception raise];
}
