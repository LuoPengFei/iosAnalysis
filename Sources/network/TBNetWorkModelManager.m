...
@interface TBNetWorkModelManager ()
{
...
@implementation TBNetWorkModelManager
...
+ (TBNetWorkModelManager *)defaultManager {
    ...
    static TBNetWorkModelManager *staticManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        staticManager=[[TBNetWorkModelManager alloc] init];
...
- (NSMutableArray *)allobjects {
    ...
    [queue inDatabase:^(FMDatabase *db) {
        ...
        while ([rs next]) {
            TBNetWorkHttpModel *model=[[TBNetWorkHttpModel alloc] init];
